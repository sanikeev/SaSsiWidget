...
namespace SaSsiWidget\Mvc\Controller\Plugin;

use SaSsiWidget\Options\ModuleOptions;
...
class SsiWidget extends AbstractPlugin implements ServiceManagerAwareInterface
{
    /**
     * @var ModuleOptions
     */
    ...
    public function getOptions()
    {
        if (!$this->options instanceof ModuleOptions) {
            $this->setOptions($this->getServiceManager()->get('SaSsiWidget-ModuleOptions'));
        }
    ...
    public function addToViewModel(ViewModel $viewModel, $request, $captureTo = null)
    {
        ...
        if ($this->surrogateCapability) {
            ...
            $result = $this->getEventManager()->trigger('ssi-mode.start', $this);
        }
        ...
        if ($this->surrogateCapability) {
            ...
            $result = $this->getEventManager()->trigger('ssi-mode.stop', $this);
        }
    ...
    protected function getEvent()
    {
        ...
        if (!$controller instanceof InjectApplicationEventInterface) {
            throw new Exception\DomainException(
                'SsiWidget plugin requires a controller that implements InjectApplicationEvent'
            );
        }
